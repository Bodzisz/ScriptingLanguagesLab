        ...
        if records != []:
            ...
            if command[0].capitalize() == 'Set' and command[1] == 'total':
                ...
                if command[2] == 'on':
                    ...
                    total = False
            elif command[0].capitalize() == 'Set' and command[1] == 'sort' and command[2] ==  'none':
                sort_by = None
                        ...
                        if command[index] == 'in':
                            ...
                            if index + 2 < len(command):
                                ...
                                if till_month in months and till_day > 0 and till_day < 32:
                                    ...
                                    raise Exception("Wrong command")
                        elif command[index] == 'sort' and len(command) > index+2 and command[index+1] == 'by':
                            index += 2
                            sort_by = command[index]
                if sort_by is not None:
                    if sort_by.lower() == 'date':
                        records_instance.sort_by_date()
                    elif sort_by.lower() == 'deaths':
                        records_instance.sort_by_deaths()
                    elif sort_by.lower() == 'cases':
                        records_instance.sort_by_cases()
